...
context('Log in to the Nucleus Wealth portal, create an individual account, and complete the onboarding portal2', () => {
    ...
    it.only('1. Validate login credentials2', function () {
